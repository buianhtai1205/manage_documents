    ...
    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card-bx bg-blue">
                                ...
                                <div class="card-info text-white">
                                    <img src="{{ asset('images/pattern/circle.png') }}" class="mb-4" alt="">
        ...
        <div class="col-xl-3 col-xxl-7">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="user-bx">
                        <img src="{{ asset('images/ion/man(1).png') }}" alt="">
                        <div>
                    ...
                    <ul class="user-list">
                        <li><img src="{{ asset('images/ion/bussiness-man.png') }}" alt=""></li>
                        <li><img src="{{ asset('images/ion/hacker.png') }}" alt=""></li>
                        <li><img src="{{ asset('images/ion/man(2).png') }}" alt=""></li>
                        <li><img src="{{ asset('images/ion/woman.png') }}" alt=""></li>
                        <li><img src="{{ asset('images/ion/man.png') }}" alt=""></li>
                        <li><img src="{{ asset('images/ion/woman.png') }}" alt=""></li>
