<div class="dlabnav">
    <div class="dlabnav-scroll-remove">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{ route('super_admin.index') }}" aria-expanded="false">
                    <i class="flaticon-025-dashboard"></i>
                    <span class="nav-text">Dashboard</span>
                </a>
            </li>
            <li><a href="{{ route('super_admin.document.index') }}" aria-expanded="false">
            ...
            <li><a href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">Headings</span>
                </a>
            </li>
            <li><a href="javascript:void()" aria-expanded="false">
